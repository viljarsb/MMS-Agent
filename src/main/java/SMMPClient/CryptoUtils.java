...
public class CryptoUtils
{
     ...
     */
    public static byte[] encryptMessage(@NonNull ECPublicKey publicKey, @NonNull ECPrivateKey privateKey, @NonNull byte[] message) throws NoSuchAlgorithmException, NoSuchPaddingException, NoSuchProviderException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException
    {
     ...
     * @throws BadPaddingException                if the padding is invalid.
     */
    public static byte[] decryptMessage(@NonNull ECPublicKey publicKey, @NonNull ECPrivateKey privateKey, @NonNull byte[] message) throws NoSuchAlgorithmException, NoSuchPaddingException, NoSuchProviderException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException
    {
        // Derive shared secret
        byte[][] ikmAndSalt = deriveSecret(publicKey, privateKey);
        byte[] ikm = ikmAndSalt[0];
     ...
     */
    public static byte[] sign(@NonNull byte[] data, @NonNull ECPrivateKey key) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
     ...
     * @throws SignatureException       if the signature is invalid.
     */
    public static boolean verifySignature(@NonNull ECPublicKey key, @NonNull byte[] data, @NonNull byte[] signature) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
